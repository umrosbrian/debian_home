...
case $HN in
    ...
    mini\.local)
        ...
        alias newtmux="tmux new-session \; rename-window vpn-rdp \; split-window -v \; split-window -v \; split-window -v \; split-window -v \; select-pane -U \; select-pane -U \; select-pane -U \; new-window \; rename-window bash \; select-window -t :1"
        ;;
    raspberrypi)
        alias mountMini="sshfs rosbrian@192.168.1.102:/Users/rosbrian ~/mini"
        ;;
