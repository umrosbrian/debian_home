...
set path=~,~/python/mypkg,~/python/scripts,~/webserver,~/webserver/static**,~/webserver/templates**,~/flask_fridays,~/docs.img-ex.com/static**,~/PycharmProjects/** " make netrw recursively search for files in Vim's current working directory
