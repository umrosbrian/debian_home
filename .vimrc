...
set path=~,~/PycharmProjects/**,~/bin/**,~/imgexflask/**,~/web/** " make netrw recursively search for files in Vim's current working directory
...
command! Pub !/home/brian/sysadmin_bin/md_to_php.py %
