...
set path=~,~/docs.img-ex.com/static**,~/PycharmProjects/**,~/bin/**,~/imgexflask/**,~/web/** " make netrw recursively search for files in Vim's current working directory
...
command! Pub !/home/brian/bin/md_to_php.py %
